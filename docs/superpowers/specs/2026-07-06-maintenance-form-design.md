...
4. On submit the worker:
   ...
   - Replaces the form (`chat.update`) with a confirmation: severity, type, sheet link, "might be related to issue #N" when dedup matched, and `cc <@U05SWHWFTEH>` for Medium/Critical.
